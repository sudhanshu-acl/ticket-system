    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-slate-900">AI Ticket Analytics</h1>
                    <p className="text-slate-600 mt-1">Visualize ticket trends and get actionable AI insights.</p>
                </div>
                ...
                <div className="flex items-center gap-3">
                    <select
                        ...
                        disabled={loading}
                        className="px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 text-sm disabled:opacity-50"
                    >
